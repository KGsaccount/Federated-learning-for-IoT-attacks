...
def save_model(model, scaler, label_encoder):
    ...
    model_path = f'trained_models/sgd_model_{timestamp}.joblib'
    scaler_path = f'trained_models/sgd_scaler_{timestamp}.joblib'
    encoder_path = f'trained_models/sgd_encoder_{timestamp}.joblib'
...
if __name__ == "__main__":
    model, scaler, label_encoder = train_sgd_model()